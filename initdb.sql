...
INSERT INTO nodes_contractors (node_id,contractor_user_id) VALUES (1,5);
       INSERT INTO conversion_routines (id,name,target_suffix,type,psystem_id) VALUES (1,'TIFF',null,'de.uzk.hki.da.convert.TiffConversionStrategy',1);
        ...
        INSERT INTO conversion_policies (id,psystem_id,source_format,conversion_routine_id,presentation) VALUES (10,1,'fmt/44',2,true);
        INSERT INTO conversion_policies (id,psystem_id,source_format,conversion_routine_id,presentation) VALUES (11,1,'fmt/44',3,false);
...
INSERT INTO queue (id,rep_name,initial_node,status,objects_id) values (1,'2015_01_14+13_50+','localnode','110', 1)    
